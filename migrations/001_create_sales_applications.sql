...
-- File: migrations/001_create_sales_applications.sql
-- Target Supabase Project: qitgpnugxjameulzhyoq
...
-- 1. Create table public.sales_applications if not exists
...
-- 2. Safely add columns if table already exists from older schema
...
-- 4. Create conservative anonymous INSERT policy
...
-- 5. Enable SELECT for anon testing if needed
